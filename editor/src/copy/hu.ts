...
export const hu = {
  ...
  capEditor: {
    ...
    lockBody: 'A kupak pontosan az előnézet szerint készül. A későbbi újraszerkesztés aranymagba kerül, és ha már nyomtatási kötegben van, csak cserével módosítható.',
