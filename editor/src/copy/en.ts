...
export const en = {
  ...
  capEditor: {
    ...
    lockBody: 'The cap is printed exactly like the preview. Editing again later costs Golden Grain, and once it is in a print batch only a replacement can change it.',
